...
const WorksBlock = observer(() => {
    ...
    return (
        <div className="works-block">
            <button className="carousel-arrow prev" onClick={() => scrolling(-300)}>
                ‹
            </button>
            ...
            <button className="carousel-arrow next" onClick={() => scrolling(300)}>
                ›
            </button>
        </div>
    )
...
const Block = (props) => {
    return (
        <div className="works-scrollbar-block">
            <div className="works-scrollbar-block_image"><a href={`/article/${props.data.id}`} style={{backgroundImage: `url(${import.meta.env.VITE_APP_API_URL + "/content/images/" + props.data.img})`}}/></div>
